...
try {
    ...
    $stats = $db->fetchRow("
        SELECT 
            ...
            SUM(CASE WHEN property_use = 'Residential' THEN 1 ELSE 0 END) as residential_properties,
            SUM(CASE WHEN property_use = 'Commercial' THEN 1 ELSE 0 END) as commercial_properties,
