    ...
    <div class="container">
        ...
        <div class="main-content" id="mainContent">
            ...
            <div class="alert fade-in">
                ...
                <p>As an Officer, you have comprehensive access to manage the revenue collection system. Here's what you can do:</p>
                <p><strong>📝 Registration:</strong> 
                    <a href="businesses/add.php" style="color: #2d5aa0; font-weight: bold;">Register new businesses</a> and 
                    <a href="properties/add.php" style="color: #2d5aa0; font-weight: bold;">register new properties</a> with GPS location capture.
                </p>
                <p><strong>💰 Payments:</strong> 
                    <a href="payments/record.php" style="color: #2d5aa0; font-weight: bold;">Record payments</a> and 
                    <a href="payments/search.php" style="color: #2d5aa0; font-weight: bold;">search account details</a> for field collection.
                </p>
                <p><strong>🧾 Billing:</strong> 
                    <a href="billing/generate.php" style="color: #2d5aa0; font-weight: bold;">Generate individual bills</a> and 
                    <a href="billing/print.php" style="color: #2d5aa0; font-weight: bold;">print bills</a> for distribution.
                </p>
                <p><strong>📍 Management:</strong> 
                    <a href="businesses/index.php" style="color: #2d5aa0; font-weight: bold;">View/edit businesses</a>, 
                    <a href="properties/index.php" style="color: #2d5aa0; font-weight: bold;">view/edit properties</a>, and 
