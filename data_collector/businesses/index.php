<?php
/**
 * Data Collector - Businesses Management
        ...
        <div class="main-content">
            ...
            <div class="stats-row fade-in">
                ...
                <div class="stat-card purple">
                    <div class="stat-value"><?php echo number_format($stats['my_businesses']); ?></div>
                ...
                <?php else: ?>
                            ...
                            <tbody>
                                <?php foreach ($businesses as $business): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <?php echo htmlspecialchars($business['zone_name'] ?? 'N/A'); ?>
                                                <?php if ($business['sub_zone_name']): ?>
                                                    <br>
                                                    <small class="text-muted">
                                                        <?php echo htmlspecialchars($business['sub_zone_name']); ?>
                                                    </small>
                                                <?php endif; ?>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <strong>₵ <?php echo number_format($business['amount_payable'], 2); ?></strong>
                                        </td>
                                        <td>
                    ...
                    <div class="pagination-wrapper">
                        <div class="pagination-info">
                            Showing <?php echo $offset + 1; ?> to <?php echo min($offset + $per_page, $total_businesses); ?> 
                            of <?php echo $total_businesses; ?> businesses
                        </div>
