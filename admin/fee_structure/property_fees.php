...
<<<<<<< HEAD
    // Get property fees with creator information
=======
...
<<<<<<< HEAD
                        <?php echo count($propertyFees); ?> fee structure<?php echo count($propertyFees) !== 1 ? 's' : ''; ?> found
                    </div>
                </div>
...
<<<<<<< HEAD
                window.location.href = `property_fees.php?action=toggle&id=${id}`;
=======
...
<<<<<<< HEAD
                window.location.href = `property_fees.php?action=delete&id=${id}`;
=======
                // Preserve current page and filters
                const url = new URL(window.location);
