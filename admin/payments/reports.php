...
<body>
        ...
        <div class="main-content" id="mainContent">
                        ...
                        <div class="filter-group">
                            ...
                            <select name="method" class="filter-control">
                                ...
                                <?php foreach ($paymentMethods as $methodOption): ?>
                                    <option value="<?php echo $methodOption; ?>" <?php echo $method == $methodOption ? 'selected' : ''; ?>>
            ...
            <div class="stats-grid">
                <div class="stat-card primary">
                    ...
                    <div class="stat-subtitle">From <?php echo number_format($totalPayments); ?> total payments</div>
                </div>
                ...
                <div class="stat-card success">
                    ...
                    <div class="stat-value"><?php echo number_format($successfulPayments); ?></div>
                ...
                <div class="stat-card info">
                    ...
                    <div class="stat-value">₵ <?php echo number_format($averagePayment, 2); ?></div>
                                ...
                                <?php else: ?>
                                    <?php foreach ($topPayments as $payment): ?>
                                        <tr>
                                            ...
                                            <td><span class="badge badge-success">₵ <?php echo number_format($payment['amount_paid'], 2); ?></span></td>
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    <?php foreach ($paymentMethodData as $method): ?>
                                        <tr>
                                            <td><strong><?php echo htmlspecialchars($method['payment_method']); ?></strong></td>
    ...
    <script>
        ...
        function exportToCSV() {
            ...
            <?php foreach ($topPayments as $payment): ?>
                csvData += "<?php echo $payment['payment_reference']; ?>,<?php echo $payment['amount_paid']; ?>,\"<?php echo addslashes($payment['payer_name']); ?>\",<?php echo $payment['payment_method']; ?>,<?php echo $payment['bill_type']; ?>,<?php echo date('Y-m-d', strtotime($payment['payment_date'])); ?>,\"<?php echo addslashes($payment['processed_by_name']); ?>\"\n";
            <?php endforeach; ?>
