...
try {
    ...
    if (isset($_POST['submit_payment']) && $_POST['submit_payment'] === 'confirmed') {
        ...
        if (!$accountData) {
            ...
            } elseif (floatval($formData['amount_paid']) > floatval($billData['amount_payable'])) {
                        ...
                        <div class="account-info-card">
                            ...
                            <div class="account-grid">
                                ...
                                <div class="account-item outstanding-balance">
                                    ...
                                    <div class="account-value amount-value">GHS <?php echo number_format($billData['amount_payable'], 2); ?></div>
                                </div>
                            </div>
                        </div>
                    <?php endif; ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="currency-input">
                                            ...
                                            <input type="number" name="amount_paid" id="amountPaid" class="form-control" 
                                                   ...
                                                   placeholder="0.00" 
                                                   min="0" max="<?php echo $billData['amount_payable']; ?>" step="0.01" required>
                                        </div>
                                        <div class="form-help">Maximum payable: GHS <?php echo number_format($billData['amount_payable'], 2); ?></div>
                                    </div>
        ...
        function showComingSoon(feature) {
            ...
            modal.innerHTML = `
                <div style="width: 80px; height: 80px; background: rgba(255,255,255,0.2);
                    ...
                    margin: 0 auto 25px; animation: pulse 2s ease-in-out infinite;">
                    <i class="fas fa-rocket" style="font-size: 2.5rem; color: white;"></i>
                    <span style="font-size: 2.5rem; display: none;">🚀</span>
                </div>
                
                <h3 style="margin: 0 0 15px 0; font-weight: 700; font-size: 1.8rem;">${feature}</h3>
                <p style="margin: 0 0 30px 0; opacity: 0.9; font-size: 1.1rem;">
                    This feature is coming soon! 🎉</p>
                
                <button onclick="closeComingSoon()" style="background: rgba(255,255,255,0.2);
            ...
            backdrop.addEventListener('click', function(e) {
                if (e.target === backdrop) closeComingSoon();
            });
        }
