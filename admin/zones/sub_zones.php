            ...
            <div class="zone-header">
                <div class="header-content">
                    ...
                    <div class="action-buttons">
                        <a href="sub_zones_add.php?zone_id=<?php echo $zoneId; ?>" class="btn btn-success">
            ...
            <div class="subzones-table-card">
                ...
                <?php if (empty($subZones)): ?>
                    <div class="empty-state">
                        ...
                        <a href="sub_zones_add.php?zone_id=<?php echo $zoneId; ?>" class="btn btn-success" style="margin-top: 15px;">
                            <i class="fas fa-plus"></i>
                            <span class="icon-plus" style="display: none;"></span>
                            Add First Sub-Zone
                        </a>
