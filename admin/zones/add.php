        ...
        if (!verifyCsrfToken($_POST['csrf_token'] ?? '')) {
            ...
            if (empty($errors)) {
                try {
                    ...
                    // Insert zone
                    $query = "INSERT INTO zones (zone_name, zone_code, description, status, created_by, created_at) 
                              VALUES (?, ?, ?, ?, ?, NOW())";
                    ...
                    // Log the action
                    writeLog("Zone created: {$formData['zone_name']} (ID: $zoneId, Status: {$formData['status']}) by user {$currentUser['username']}", 'INFO');
                    ...
                    $errors[] = 'An error occurred while creating the zone. Please try again.';
                }
            }
        }
    }
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <select name="status" id="zoneStatus" class="form-control" required>
                                    <option value="active" <?php echo $formData['status'] === 'active' ? 'selected' : ''; ?>>Active</option>
                                    <option value="inactive" <?php echo $formData['status'] === 'inactive' ? 'selected' : ''; ?>>Inactive</option>
                                </select>
                                <div class="form-help">Set the initial status of the zone</div>
                            </div>
                        </div>
                    ...
                    <div class="tips-card">
                        ...
                        <ul class="tips-list">
                            ...
                            <li>
                                ...
                                <span>Zones help organize businesses and properties for better billing management</span>
                            </li>
                        </ul>
                    </div>
                </div>
