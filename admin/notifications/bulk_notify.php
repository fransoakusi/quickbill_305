<?php
/**
 * Bulk Notifications - Following Admin Structure
 * QUICKBILL 305 - Send bulk notifications
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'preview') {
        ...
        try {
            ...
            $notificationType = $_POST['notification_type'] ?? 'SMS';
            ...
            foreach ($recipients as $recipient) {
                try {
                    ...
                    // Simulate sending (replace with actual SMS/email sending)
                    $result = ['success' => true]; // 90% success rate for demo
                    if (rand(1, 10) === 1) {
            ...
            $message = "Bulk notification completed. {$successCount} sent successfully, {$failureCount} failed.";
            $messageType = $failureCount > 0 ? 'warning' : 'success';
        ...
        switch ($criteria) {
            case 'all_defaulters':
                ...
                $businesses = $db->fetchAll("
                    ...
                    FROM businesses 
                    WHERE amount_payable > 0 AND telephone IS NOT NULL AND telephone != ''
            ...
            case 'zone':
                ...
                if ($zoneId > 0) {
                    $businesses = $db->fetchAll("
                        ...
                        FROM businesses 
                        WHERE zone_id = ? AND telephone IS NOT NULL AND telephone != ''
                        ORDER BY business_name
                        LIMIT 200
                    ", [$zoneId]);
            ...
            case 'business_type':
                ...
                if (!empty($businessType)) {
                    $recipients = $db->fetchAll("
                        SELECT business_id as id, business_name as name, telephone as phone, 'Business' as type
                        FROM businesses 
                        WHERE business_type = ? AND telephone IS NOT NULL AND telephone != ''
                        ORDER BY business_name
                        LIMIT 300
                    ", [$businessType]);
                }
        ...
        <div class="main-content" id="mainContent">
            ...
            <div style="margin-bottom: 30px;">
                ...
                <p style="color: #718096; font-size: 16px;">
                    Send notifications to multiple recipients based on specific criteria.
                </p>
            </div>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title">🎯 Step 1: Select Recipients</h5>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <!-- Defaulters Options -->
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="criteria-card" onclick="selectCriteria('all_businesses')">
                                            <label style="cursor: pointer; margin-bottom: 0;">
                                                ...
                                                <small style="color: #718096;">All active businesses with phone numbers</small>
                                            </label>
                                        </div>
                                        ...
                                        <div class="criteria-card" onclick="selectCriteria('all_properties')">
                                            <label style="cursor: pointer; margin-bottom: 0;">
                                                ...
                                                <small style="color: #718096;">All properties with phone numbers</small>
                                            </label>
                                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6" id="subjectField" style="display: none;">
                                        ...
                                        <input type="text" name="subject" class="form-control" placeholder="Notification subject">
                                    </div>
                                </div>
                                ...
                                <div class="alert alert-warning" style="margin-top: 15px;">
                                    <i class="fas fa-exclamation-triangle"></i>
                                    <span class="icon-warning" style="display: none;"></span>
                                    <strong>Important:</strong> Bulk notifications will be sent to all recipients in the selected criteria. 
    ...
    <script>
        ...
        document.getElementById('bulkForm').addEventListener('submit', function(e) {
            ...
            if (action === 'send') {
                ...
                if (!confirm('Are you sure you want to send this bulk notification? This action cannot be undone.')) {
                    e.preventDefault();
                    return;
                }
            }
