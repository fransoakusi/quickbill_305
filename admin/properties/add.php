<?php
/**
 * Properties Management - Add New Property
...
try {
    ...
    $subZones = $db->fetchAll("SELECT * FROM sub_zones ORDER BY sub_zone_name");
    ...
    <script>
        ...
        function updateSubZone() {
            ...
            if (zoneId) {
                ...
                const zoneSubZones = subZones.filter(subZone => subZone.zone_id == zoneId);
