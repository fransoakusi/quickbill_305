...
<<<<<<< HEAD
    $qr_data = json_encode([
        ...
        'amount_payable' => number_format($bill['amount_payable'] ?? 0, 2),
        'currency' => 'GHS'
...
<<<<<<< HEAD
                        ...
                        .bill-header-right { text-align: right; z-index: 2; }
                        ...
                        .bill-content { display: flex; justify-content: space-between; margin-top: 20px; position: relative; z-index: 2; gap: 30px; }
                        .bill-left-section, .bill-right-section { width: 48%; }
                        .bill-info-box { border: 2px solid #000; padding: 15px; margin-bottom: 20px; position: relative; z-index: 2; background: white; }
                        .bill-info-box p { margin: 8px 0; font-size: 14px; color: #000; }
                        .bill-info-box p strong { display: inline-block; width: 140px; font-weight: bold; }
                        .bill-table { width: 100%; border-collapse: collapse; margin-bottom: 20px; position: relative; z-index: 2; }
                        .bill-table, .bill-table th, .bill-table td { border: 1px solid #000; padding: 8px; text-align: center; font-size: 14px; }
                        .bill-table th { background-color: #f0f0f0; font-weight: bold; color: #000; }
                        ...
                        .bill-qr-code img { width: 100px; height: 100px; border: 1px solid #ddd; }
                        .bill-footer { border-top: 2px solid #000; padding-top: 15px; text-align: center; font-size: 13px; position: relative; z-index: 2; color: #000; margin-top: 30px; }
