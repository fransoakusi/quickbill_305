            ...
            try {
                ...
                if ($generationType === 'all' || $generationType === 'businesses' || ($generationType === 'specific' && $specificType === 'business')) {
                    ...
                    foreach ($businesses as $business) {
                        ...
                        // Calculate amounts (triggers will handle amount_payable calculation)
                        ...
                        // Update business current bill (trigger will handle amount_payable)
                        $db->execute("
                            UPDATE businesses 
                            SET current_bill = ?
                            WHERE business_id = ?
